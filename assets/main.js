...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#image04', { style: 'fade-up', speed: 500, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image13', { style: 'fade-up', speed: 500, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image14', { style: 'fade-up', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#image12', { style: 'fade-up', speed: 1500, intensity: 5, delay: 0, replay: false });
