...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('#text25', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#text23', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#text24', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('#buttons10', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
