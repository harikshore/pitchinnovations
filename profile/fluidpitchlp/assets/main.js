	...
	// Slideshow: slideshow02.
		(function() {
			...
			new slideshowBackground('#slideshow02', {
				...
				images: [
					{
						src: 'assets/images/slideshow02-1aeaefaa.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'ARR',
					...
					{
						src: 'assets/images/slideshow02-ff76e7a5.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'Brian Transeau',
					},
					{
						src: 'assets/images/slideshow02-d9bd5391.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'Jordan Rudess',
					},
					{
						src: 'assets/images/slideshow02-5a562d79.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'KSHMR',
					...
					{
						src: 'assets/images/slideshow02-bc484deb.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'Karem Matar',
					...
					{
						src: 'assets/images/slideshow02-6bda5ed3.jpg',
						position: 'top left',
						motion: 'none',
						speed: 2,
						caption: 'Mahesh Raghvan',
					},
				]
			});
